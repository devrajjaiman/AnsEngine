   ...
   <div id="cA">
    ...
    <table style="margin:10px 0 0 0;" class="tablebg" width="100%" cellpadding="0" cellspacing="0">
        <tbody>
                ...
                <tr>
                    <td colspan="2"  height="60" class="row1" width="600" align="left" ><a class="forumlink"  href="ashow.jsp?qid=<%= qid%>&idc=<%= idc %>"><%= qus %> </a>
	            </td>
                    <td height="60"  class="row2" width="50" align="center"><%
			   if(admin.equals("devraj"))
			   { //int qst= 258;
                               String qst= "frt";
			      String link2 = "adelete.jsp?qid="+qid+"&idc="+idc+"&qst="+qst ;
				 %>
