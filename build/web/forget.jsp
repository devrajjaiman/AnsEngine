...
<body>
  ...
  <div id= "hh">
      <div id="logo">
           ...
           function check()
	   {
                  ...
                  var v12 =  document.forms["myform1"]["U_name"].value;
		  if (v12==null||v12 == "")
		 	 {   alert("Please Enter User name ");
                 ...
                 var v11 =  document.forms["myform1"]["N_name"].value;
		  if (v11==null||v11 == "")
		 	 {   alert("Please Enter Nick name ");
                ...
                var v3 =  document.forms["myform1"]["Password"].value;
		 if(v3==null||v3 == "")
		...
		var v4 =  document.forms["myform1"]["C_password"].value;
		 if(v4==null||v4 == "")
        ...
        <div class="content">
             <h1 style="margin: 60px 0 0 0;">Forget Password</h1>
              <%
              ...
              <%    String uname = request.getParameter("U_name");
                 String nick = request.getParameter("N_name");
 ...
 st.executeUpdate("UPDATE register SET Passwaord='"+pass+"',C_Password='"+cpass+"' WHERE U_name='"+uname+"' AND N_name= '"+nick+"'" );
        ...
        if(uname == null && pass == null)
			{  }
                        else
		       {
					  ...
					  ss="User Name OR Nick Name Wrong";
					 }
			cn.close();
                        ...
                        <font color="red">   <% out.println(ss);%></font>




          <form name="myform1" id="contact" action="forget.jsp" method="post" onsubmit="return check()">
          <div class="form_settings">
                 <span>User Name:</span>   <p><input class="contact" type="text" name="U_name" value="" /></p>
                  <span>Nick Name:</span>   <p><input class="contact" type="text" name="N_name" value=""   /></p>
                 <p><span>New Password:</span><input class="contact" type="password" name="Password" value=""  /></p>
                 <p><span>Confirm New Password:</span><input class="contact" type="password" name="C_password" value=""  /></p>
