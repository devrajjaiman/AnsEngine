      ...
      <div id="logo">
        <div id="logo_text">
          ...
          <!-- class="logo_colour", allows you to change the colour of the text -->
           <h3> <p align="right">Welcome Admin</p></h3>
          ...
          <ul class="sf-menu" id="nav">
               ...
               <li><a href="#">Profile</a>
                    <ul>
                        ...
                        <li><a href='alogout.jsp'>Log Out</a></li>
                     </ul>
                </li>
               ...
               try{
                 ...
                 //     Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
                  ...
                  %>
                    <tr><% int s=1;%>
                        ...
                        <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s%>" >C Language</a>
                 ...
                 break;
                    ...
                    <tr><% int s1=2;%>
                         ...
                         <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s1%>">C++ Language</a>
                 ...
                 break;
                    ...
                    <tr><% int s3=3;%>
                        ...
                        <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s3%>">java / Jsp</a>
                 ...
                 break;
                    ...
                    <tr><% int s4=4;%>
                        ...
                        <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s4%>">HTML /CSS /Javascript / Webdevelopment</a>
	                             <p class="forumdesc">One of the most popular programming languages of all time. C has also greatly influenced many other popular programming languages.</p>
                        </td>
                 ...
                 break;
                    ...
                    <tr><% int s5=5;%>
                        ...
                        <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s5%>">PHP</a>
                 ...
                 break;
                    ...
                    <tr><% int s6=6;%>
                        ...
                        <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s6%>">SQL & Database</a>
                 ...
                 break;
                    ...
                    <tr><% int s7=7;%>
                        ...
                        <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s7%>">.Net / C#</a>
                 ...
                 break;
                    ...
                    <tr><% int s8=8;%>
                        ...
                        <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s8%>">All Other Programming Languages</a>
                 ...
                 break;
                    ...
                    <tr><% int s9=9;%>
                        ...
                        <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s9%>">Adobe /Dreamweaver /Flash /Photoshop</a>
                 ...
                 break;
                    ...
                    <tr><% int s10=10;%>
                         ...
                         <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s10%>">Game Design / Animation</a>
                 ...
                 break;
                    ...
                    <tr><% int s11=11;%>
                         ...
                         <td class="row1" width="600"><a class="forumlink"  href="atopics.jsp?idc=<%= s11%>">Tutorials / Projects</a>
